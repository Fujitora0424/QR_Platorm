...
namespace QR_Tool_Winform.Certificate
{
...
string password)
        ...
        public static string GetCertificateString(string certPath)
        {
            using (FileStream fsRead = new FileStream(certPath, FileMode.Open))
            {
